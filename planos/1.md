...
1. Entrada: texto multi-linha. Primeira linha pode ser um título (ex.: "Amigo Secreto - Quarta Parede/Teatro Incessante") — detecte e guarde como group_name se houver.
2. Cada participante por linha. Separadores esperados: tab (\t), múltiplos espaços ou ' - ' entre nome e telefone. Ex.: "Mírian Valério\t53 98121-2594" ou "Mariane 53 99975-0727".
...
- POST /api/parse
  ...
  - Output 200: {
      "group_name": "Amigo Secreto - Quarta Parede/Teatro Incessante" | null,
      "participants": [
        { "id": "<uuid>", "name": "Mírian Valério", "phone_raw":"53 98121-2594", "phone_digits":"5539981212594", "is_phone_valid": true }
      ],
...
- Os números no exemplo parecem já ter um DDD ("53 ...") e não mostram claramente o código do país. Configurar default_country_code = "55" (Brasil) geralmente funciona: transforma "53 98121-2594" em "55539981212594" para wa.me.
